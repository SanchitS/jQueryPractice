...
//____________________________________chapter_02/01_document_ready/script.js
//
//$(document).ready(function(){
//	alert('Welcome to StarTrackr! Now no longer under police investigation!');
//});

//____________________________________chapter_02/02_selecting/script.js
//
//$(document).ready(function() {
//    alert($('#celebs tr').length + ' elements!');
//});

//____________________________________chapter_02/03_narrowing_selection/script.js
//
//$(document).ready(function () {
...
//____________________________________chapter_02/04_filters/script.js
//
//$(document).ready(function () {
